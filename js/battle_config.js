...
const SkillConfig = {
    1: { id: 1, name: '基础攻击', damagePercent: 1.0, cd: 2 },
...
const LevelConfig = {
    levels: [
        ...
        {id: 7, levelName: "箭雨齐发", enemyIds: [102, 102, 102], enemyLevels: [3, 3, 3], rewards: [{itemId: 1, quantity: 3500}, {itemId: 2, quantity: 1500}, {itemId: 3, quantity: 1}]},
        {id: 8, levelName: "混编部队", enemyIds: [101, 102, 103, 101], enemyLevels: [5, 5, 5, 5], rewards: [{itemId: 1, quantity: 4000}, {itemId: 2, quantity: 2000}, {itemId: 3, quantity: 2}]},
        {id: 9, levelName: "将领对决", enemyIds: [103, 103], enemyLevels: [8, 8], rewards: [{itemId: 1, quantity: 6000}, {itemId: 2, quantity: 3000}, {itemId: 3, quantity: 3}]},
        {id: 10, levelName: "终极试炼", enemyIds: [101, 102, 103, 101, 102], enemyLevels: [15, 15, 15, 15, 15], rewards: [{itemId: 1, quantity: 10000}, {itemId: 2, quantity: 5000}, {itemId: 3, quantity: 5}, {itemId: 4, quantity: 2}]}
    ],
    items: [
...
const companionConfig = {
    1: { name: "少羽", avatar: "player1.png" },
    2: { name: "荆紫", avatar: "player2.png" }
};
